...
const screens = createDrawerNavigator(
  {
    ...
    Home: {
      ...
      navigationOptions: {
        drawerLabel: "Home",
        drawerIcon: (props) => (
          <MenuIcon name="home" family="FontAwesome" focused={props.focused} />
        ),
      },
    },
    Onboarding: {
    ...
    Settings: {
      ...
      navigationOptions: {
        ...
        drawerIcon: (props) => (
          <MenuIcon name="settings" family="Ionicons" focused={props.focused} />
        ),
      },
    },
    Profile: {
      ...
      navigationOptions: {
        drawerLabel: "Profile",
        drawerIcon: (props) => (
          <MenuIcon name="user" family="Entypo" focused={props.focused} />
        ),
      },
    },
    Cards: {
